    ...
    namespace rest
    {
        namespace internal
        {
            class rest_api_client
            {
                ...
                private:
                    pplx::task<web::http::http_response> request_internal(route_info& route, web::http::http_request request, pplx::cancellation_token token = pplx::cancellation_token::none());
